...
namespace Recommender_ML
{
    public partial class MovieRecommender
    {
        public const string RetrainFilePath =  @"C:\Users\anyan\source\repos\StyleSense\Recommender\Recommender.ML\recommendation-ratings-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"movieId",inputColumnName:@"movieId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"rating",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"movieId",ApproximationRank=11,LearningRate=0.00302693252441326,NumberOfIterations=6723,Quiet=true}))      
